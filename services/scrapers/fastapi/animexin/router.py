...
async def get_home():
    provider = get_provider("animexin")()
    try:
        ...
        return ApiResponse(
            ...
            meta={"provider": "animexin", "category": "donghua"},
        )
...
async def az_list(
    ...
    try:
        ...
        return ApiResponse(
            ...
            message=result.get("message", ""),
            data=result.get("data"),
            meta={"provider": "animexin", "show": show, "page": page},
        )
    except Exception as e:
